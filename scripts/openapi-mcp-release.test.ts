...
test.each([
  ...
  ["feat(foo/bar): add feature", null],
  ["fix(other/module): repair feature", null],
  [
    "docs(other/module): redefine contract\n\nBREAKING CHANGE: remove contract",
    null,
  ],
  ["feat(openapi-mcp/other): add feature", null],
  ["fix(.other): repair feature", null],
  ["perf(.openapi-mcp): speed up feature", null],
  ["feat(foo/bar)!: replace feature", null],
  ["feat(openapi-mcp/other)!: replace feature", null],
  ["docs(.other): redefine contract\n\nBREAKING CHANGE: remove contract", null],
  ["docs/a(openapi-mcp): explain search", null],
  [".docs(openapi-mcp): explain search", null],
  [
    "revert/a(openapi-mcp): undo change\n\nThis reverts commit abcdef1234567890.",
    null,
  ],
  [
    ".revert(openapi-mcp): undo change\n\nThis reverts commit abcdef1234567890.",
